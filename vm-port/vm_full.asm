...
EVENT_RUN_PTR          EQU 0x9333          ; next alternating run byte
EVENT_RUN_REMAIN       EQU 0x9335
EVENT_RUN_KEEP         EQU 0x9336
...
; Sequential top-level draw filter generated by offline final-pixel ownership.
; The stream alternates dead/live run lengths and is consumed once for every
; shape or string command, including page-0 and page-3 work.
visual_event_live:
        ld a,(EVENT_RUN_REMAIN)
        or a
        jr nz,.consume
.next:
        ld a,(EVENT_RUN_KEEP)
